...
public class BillServiceTest {
    ...
    @Spy //Es porque quiero probar el metodo billingConsumidorFinalTest
    @InjectMocks // Inyecto las instancias del mock
    ...
    public void billingConsumidorFinalTest() {
        ...
        // when
        when(customerService.getDefaultCustomer()).thenCallRealMethod(); //Devolve el metodo real
        when(itemService.calculateNetAmount(itemsToBill)).thenReturn(itemsBilled);//Te paso la lista de items  y devolve los esperado,POR QUE ES VOID 
